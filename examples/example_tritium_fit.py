...
##
## Some of the values below have been assumed and are not based on real data. 
## The purpose of this example is to demonstrate how to set up a parameter estimation 
## problem in PathSim for a more complicated system. It does, however, provide an 
## accurate model of the dynamics of a tritium reactor.         
##
#########################################################################################
